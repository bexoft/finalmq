...
[finalmq.MetaStruct("Call StartRequest to start the timer event.")]
...
[finalmq.MetaStruct("Call StopRequest to stop the timer event.")]
...
[finalmq.MetaStruct("The server triggers this event to all connected clients.")]
public class TimerEvent : finalmq.StructBase, IEquatable<TimerEvent>
{
	...
	[finalmq.MetaField("The current time.")]
    public string time
	{
		get { return m_time; }
		set { m_time = value; }
