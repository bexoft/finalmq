...
enum MetaTypeId
{
    ...
    TYPE_ARRAY_FLAG       = 1024,

    TYPE_ARRAY_BOOL       = TYPE_ARRAY_FLAG + TYPE_BOOL,
    TYPE_ARRAY_INT32      = TYPE_ARRAY_FLAG + TYPE_INT32,
    TYPE_ARRAY_UINT32     = TYPE_ARRAY_FLAG + TYPE_UINT32,
    TYPE_ARRAY_INT64      = TYPE_ARRAY_FLAG + TYPE_INT64,
    TYPE_ARRAY_UINT64     = TYPE_ARRAY_FLAG + TYPE_UINT64,
    TYPE_ARRAY_FLOAT      = TYPE_ARRAY_FLAG + TYPE_FLOAT,
    TYPE_ARRAY_DOUBLE     = TYPE_ARRAY_FLAG + TYPE_DOUBLE,
    TYPE_ARRAY_STRING     = TYPE_ARRAY_FLAG + TYPE_STRING,
    TYPE_ARRAY_BYTES      = TYPE_ARRAY_FLAG + TYPE_BYTES,
    TYPE_ARRAY_STRUCT     = TYPE_ARRAY_FLAG + TYPE_STRUCT,
    TYPE_ARRAY_ENUM       = TYPE_ARRAY_FLAG + TYPE_ENUM,
};
